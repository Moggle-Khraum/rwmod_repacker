...
function initChangelogModal() {
    ...
    const changelogData = {
        'v1.3.1': {
            date: 'Released: September 2024',
            changes: [
                {
                    title: 'Improvements',
                    icon: 'fas fa-arrow-up',
                    items: [
                        'Enhanced the tampering function for better protection',
                ...
                },
                {
                    ...
                    icon: 'fas fa-bug',
                    items: [
                        'Fixed rare crash when processing large mod files',
                        'Resolved issue with special characters in file names',
                        'Fixed memory leak in the obfuscation process'
                    ]
                }
            ]
        },
        'v1.3.0': {
            date: 'Released: August 2024',
            changes: [
                {
                    title: 'New Features',
                    icon: 'fas fa-plus',
                    items: [
                        ...
                        'Complete mod protection system',
                ...
                },
                {
                    ...
                    icon: 'fas fa-cog',
                    items: [
                        'Advanced dummy structuring',
                        'File encapsulation technology',
            ...
            changes: [
                {
                    ...
                    icon: 'fas fa-box',
                    items: [
                        'Created installer version for Windows',
                        'Developed portable version for cross-platform use',
                ...
                },
                {
                    ...
                    icon: 'fas fa-vial',
                    items: [
                        'Extensive beta testing completed',
        ...
        'v1.1.0': {
            date: 'Released: May 2024',
            changes: [
                {
                    title: 'Initial Development',
                    icon: 'fas fa-rocket',
                    items: [
                        'First working build created',
    ...
    // Add click listeners to changelog items
    ...
    function showModal(version, data) {
        ...
        // Set release date
        modalReleaseDate.textContent = data.date;
        
        // Build changes content
        let changesHTML = '';
        data.changes.forEach(section => {
            changesHTML += `
        ...
        modalChanges.innerHTML = changesHTML;
